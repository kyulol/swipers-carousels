...
Paper Onboarding is a simple and easy to use materia design onboarding slider (based on [Swiper](https://swiperjs.com)) for your app.
...
- correctly handles "paper" animation direction for both vertical and horizontal Swiper directions
- any content can be placed within slides
- slides colors are customizable

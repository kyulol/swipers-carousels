...
Travel Slider is a simple and easy to use slider (based on [Swiper](https://swiperjs.com)) that allows you to swipe (slide) through travel destinations with rotating planet behind.

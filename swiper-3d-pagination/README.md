...
This template demonstrates how to create such [Swiper](https://swiperjs.com) with 3D pagination.

There are two implementations (templates) available:

## Cube Swiper

In this template main Swiper uses `cube` effect, and 3D pagination is under the main Swiper.

## Coverflow Swiper

In this template main Swiper uses `coverflow` effect, and 3D pagination is in the bottom in front of the main Swiper.

...
Triple Slider is a simple and easy to use triple slider template (based on [Swiper](https://swiperjs.com)). Three Swipers work as one to allow you to swipe (slide) through cards with pictures and see previous and next slides.
